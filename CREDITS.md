...
## Bundled music (Creative Commons)

Every track below was verified against the Internet Archive's own license
metadata before bundling. Only plain **CC BY** / **CC0** works are included —
no NC/SA/ND, and none of SwapXFO's arrangements of copyrighted game music.

| Track | Artist | License | Source |
|---|---|---|---|
| Dubious Dream | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-dubious-dream |
| funky code mod | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-funky-code-mod |
| 10 PRINT HELLO WORLD | Andrey Avkhimovich | CC BY 3.0 | https://archive.org/details/AAS006 |
| High-speed Dilemma | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-high-speed-dilemma |
| Long Lost Home | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-long-lost-home |
| Ground Battery | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-ground-battery |
| Liquid Sugar Overload | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-liquid-sugar-overload |
| Star Dichotomy | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-star-dichotomy |
| 50ºC | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-50-degrees |
| An Insomniac's Walk Through the Night | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-an-insomniac-s-walk-through-the-night |
| Fox's Nest | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-foxs-nest |
| 116112 | SwapXFO | CC BY 4.0 | https://archive.org/details/116112 |
| The Beaten Path | SwapXFO | CC BY 4.0 | https://archive.org/details/the-beaten-path |
| Dreaming of Whoever | SwapXFO | CC BY 4.0 | https://archive.org/details/dreaming-of-whoever |
| Unprecedented Happiness | SwapXFO | CC BY 4.0 | https://archive.org/details/unprecedented-happiness |
| Project Onto the Sea | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-project-onto-the-sea |
| Ups and Downs | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-ups-and-downs |
| Chill Fite | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-chill-fite |
| Abstract Space Adventure | SwapXFO | CC BY 4.0 | https://archive.org/details/mus-abstract-space-adventure |
| Introducing the Pre-roll | Lee Rosevere | CC BY 4.0 | https://archive.org/details/leerosevere_musicforpodcasts_5 |
| All the Answers | Lee Rosevere | CC BY 4.0 | https://archive.org/details/leerosevere_musicforpodcasts_5 |
| Thinking It Over | Lee Rosevere | CC BY 4.0 | https://archive.org/details/leerosevere_musicforpodcasts_5 |
| You're Enough | Lee Rosevere | CC BY 4.0 | https://archive.org/details/leerosevere_musicforpodcasts_5 |
| Let That Sink In | Lee Rosevere | CC BY 4.0 | https://archive.org/details/leerosevere_musicforpodcasts_6 |
| Thought Bubbles | Lee Rosevere | CC BY 4.0 | https://archive.org/details/leerosevere_musicforpodcasts_6 |
| Going In Circles | Lee Rosevere | CC BY 4.0 | https://archive.org/details/leerosevere_musicforpodcasts_6 |
| Bigger Questions | Lee Rosevere | CC BY 4.0 | https://archive.org/details/leerosevere_musicforpodcasts_6 |
...
- MediaPipe Tasks Vision (face detection, on-device) — Apache 2.0
- qrcode — MIT
- Vite / TypeScript toolchain

## Kiosk edition only

The personal kiosk build additionally tunes into SomaFM (somafm.com,
listener-supported internet radio) and Nightwave Plaza. Those streams are
not part of any distributed build.
