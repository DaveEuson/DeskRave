# Evaluate a JS expression in the RUNNING kiosk page via CDP; prints the result
# as JSON. awaitPromise so async expressions resolve.
#   python3 cdpeval.py "location.href"
...
send({"id": 1, "method": "Runtime.evaluate", "params": {"expression": expr, "returnByValue": True, "awaitPromise": True}})
for _ in range(50):
    r = recv()
    if r.get("id") == 1:
